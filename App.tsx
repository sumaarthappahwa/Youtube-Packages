              ...
              <div key={idx} className="group relative">
                <div className="bg-gray-900/50 backdrop-blur-xl border border-white/5 rounded-[3rem] overflow-hidden transition-all duration-500 hover:border-red-500/30">
                  <div className="p-10">
                    ...
                    <p className="text-gray-400 font-medium leading-relaxed text-sm italic">"{study.description}"</p>
                  </div>
      ...
      <section className="py-24 px-6 bg-white relative overflow-hidden">
        <div className="max-w-4xl mx-auto bg-gray-50 rounded-[3rem] p-10 md:p-16 border border-gray-100 shadow-2xl relative">
          ...
          <div className="space-y-6">
            ...
            {aiRecommendation && (
              <div className="mt-8 p-8 bg-white border border-red-100 rounded-[2rem] shadow-xl">
              ...
              >
                ...
                <div className="space-y-6 mb-8 flex-1">
                  <div className="grid grid-cols-2 gap-4 pb-6 border-b border-gray-100">
                    <div className="text-center p-4 rounded-3xl bg-gray-50">
                      <div className="text-2xl font-black text-red-600">{pkg.videosTotal}</div>
                      <div className="text-[9px] uppercase tracking-widest text-gray-400 font-black">Videos</div>
                    </div>
                    <div className="text-center p-4 rounded-3xl bg-gray-50">
                ...
                <Button fullWidth variant={pkg.isPopular ? 'primary' : 'outline'} onClick={() => window.open(pkg.paymentLink, '_blank')}>
                  Get Started
                </Button>
              </div>
            ))}
      ...
      <footer className="py-16 bg-white border-t border-gray-100">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-500 text-sm font-bold">
            Powered by <a href="https://www.dodigital.marketing" target="_blank" className="text-red-600 underline underline-offset-8">Do Digital Marketing</a>
          </p>
        </div>
      </footer>

      {/* WhatsApp Link */}
      <a href="https://wa.me/917217873028" target="_blank" className="whatsapp-float group px-6 py-4 rounded-full flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white shadow-2xl transition-all duration-300 fixed bottom-8 right-8">
